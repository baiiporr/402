            ...
            <form id="term">
                <div class="a">
                    <div class="row form-group">
                        <label class="text-center col-md-2 control-label">เอกสารการสมัคร</label>
                        <div class="col-md-5">
            ...
            <div class="d">
                <div class="form-group row">
                    <div class="col-md-7 text-center">
                        <button class="btn btn-large btn-danger" type="button" onclick="Edit()"> รอเอกสาร
                        </button>
